...
const NAV_ITEMS = [
  ...
  { href: "/admin/control", label: "Control Center", icon: "control" },
  { href: "/admin/posts", label: "Posts", icon: "doc" },
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-[60] rounded-lg bg-zinc-800 p-2 text-zinc-400 lg:hidden"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[70] lg:hidden">
          <div
            ...
            onClick={() => setMobileOpen(false)}
          />
          <aside className="relative flex h-full w-64 flex-col bg-zinc-900 shadow-xl">
            {nav}
          </aside>
        </div>
      )}
      ...
      {/* Desktop sidebar */}
      <aside className="hidden w-64 shrink-0 border-r border-zinc-800 bg-zinc-900/50 lg:flex lg:flex-col">
        {nav}
      </aside>
    </>
  );
